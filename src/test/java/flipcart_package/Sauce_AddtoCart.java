...
public class Sauce_AddtoCart {
	...
	Sauce_AddtoCart(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void button_shoppingcart()
	{
	 driver.findElement(button_shoppingcart).click();
	}
	
	public void button_continueshopping()
	{
	 driver.findElement(button_continueshopping).click();
	}
